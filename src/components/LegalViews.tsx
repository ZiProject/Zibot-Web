		...
		return (
			<LegalLayout title={t("terms")}>
				<section>
					...
					<p>
						Bằng cách sử dụng Ziji Bot, bạn đồng ý tuân thủ các điều khoản này và Quy định dịch vụ của Discord. Nếu bạn không đồng
				...
				<section>
					...
					<p>
						Ziji Bot cung cấp các tính năng giải trí, âm nhạc và quản trị máy chủ. Bạn không được sử dụng bot cho các mục đích vi
						phạm pháp luật hoặc quấy rối người dùng khác.
					</p>
				</section>
				...
				<section>
					...
					<p>
						Chúng tôi không chịu trách nhiệm về bất kỳ thiệt hại nào phát sinh từ việc sử dụng hoặc không thể sử dụng bot. Dịch vụ
						được cung cấp "như hiện tại".
					</p>
				</section>
				...
				<section>
					...
					<p>
						Ziji Project có quyền cập nhật các điều khoản này bất cứ lúc nào. Việc tiếp tục sử dụng bot sau khi thay đổi có nghĩa
		...
		return (
			<LegalLayout title={t("terms")}>
				<section>
					...
					<p>
						Zijiボットを使用することで、これらの規約およびDiscordのサービス規約を遵守することに同意したことになります。同意しない場合は、直ちにサービスの使用を中止してください。
					</p>
				</section>
				...
				<section>
					...
					<p>
						Zijiボットはエンターテインメント、音楽、およびサーバー管理機能を提供します。法律に違反する目的や、他のユーザーを嫌がらせする目的でボットを使用することはできません。
					</p>
				</section>
				...
				<section>
					...
					<p>
						ボットの使用または使用不能から生じるいかなる損害についても、当社は責任を負いません。サービスは「現状のまま」提供されます。
					</p>
				</section>
				...
				<section>
					...
					<p>
						Zijiプロジェクトは、いつでもこれらの規約を更新する権利を有します。変更後もボットを継続して使用することは、新しい規約に同意したことを意味します。
					</p>
				</section>
			</LegalLayout>
		);
	...
	return (
		<LegalLayout title={t("terms")}>
			<section>
				...
				<p>
					By using Ziji Bot, you agree to comply with these terms and Discord's Terms of Service. If you do not agree, please stop
			...
			<section>
				...
				<p>
					Ziji Bot provides entertainment, music, and server administration features. You must not use the bot for illegal
					purposes or to harass other users.
				</p>
			</section>
			...
			<section>
				...
				<p>
					We are not responsible for any damages arising from the use or inability to use the bot. The service is provided "as
					is".
				</p>
			</section>
			...
			<section>
				...
				<p>
					Ziji Project reserves the right to update these terms at any time. Continued use of the bot after changes implies
		...
		return (
			<LegalLayout title={t("privacy")}>
				...
				<section>
					...
					<p>
						Chúng tôi thu thập các thông tin tối thiểu cần thiết để vận hành bot, bao gồm: ID người dùng, ID máy chủ, và các cài
						đặt cấu hình trong máy chủ của bạn.
					</p>
				</section>
				...
				<section>
					...
					<p>
						Dữ liệu được sử dụng để cá nhân hóa trải nghiệm (như cấp độ RPG, số dư kinh tế) và thực hiện các lệnh quản trị do bạn
						yêu cầu.
					</p>
				</section>
				...
				<section>
					...
					<p>
						Bạn có quyền yêu cầu xóa toàn bộ dữ liệu liên quan đến tài khoản của mình bằng cách liên hệ với đội ngũ hỗ trợ qua máy
						chủ Discord chính thức.
					</p>
				</section>
			</LegalLayout>
		);
		...
		return (
			<LegalLayout title={t("privacy")}>
				...
				<section>
					...
					<p>
						データは、エクスペリエンスのパーソナライズ（RPGレベル、経済残高など）や、リクエストされた管理コマンドの実行に使用されます。
					</p>
				</section>
				...
				<section>
					...
					<p>
						公式のDiscordサーバーを通じてサポートチームに連絡することで、アカウントに関連するすべてのデータの削除をリクエストする権利があります。
					</p>
				</section>
			</LegalLayout>
		);
	...
	return (
		<LegalLayout title={t("privacy")}>
			...
			<section>
				...
				<p>
					We collect the minimum information necessary to operate the bot, including: User ID, Server ID, and configuration
					settings within your server.
				</p>
			</section>
			...
			<section>
				...
				<p>
					Data is used to personalize the experience (such as RPG levels, economic balance) and execute administrative commands
					requested by you.
				</p>
			</section>
			...
			<section>
				...
				<p>
					You have the right to request the deletion of all data related to your account by contacting the support team via the
